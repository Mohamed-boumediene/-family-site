...
<div id="page">
    ...
    <div class="container-fliud">
            ...
            <div class="gtco-container">
                ...
                <div class="row">
                    <div class="col-sm-4 col-xs-12">
                        <div id="gtco-logo"><a href="HomePage.php">SmartProNetwork <em>.</em></a>
                        </div>

                    </div>
                    <div class="col-xs-8 text-right menu-1">
                        <ul>
                            <li><a href="features.html">National</a></li>
                            <li><a href="tour.html">Enterprise</a></li>
        ...
        <!-- Header Carousel -->
        <header id="myCarousel" style="" class=" carousel slide">
            <!-- Indicators -->
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="../images/00.png"  style="     width: 1400px; height: 300px;" alt="..." class="grayscale">
                    <!--<div id="gtco-header" class="gtco-cover" role="banner" style="background-image: url(images/img_4.jpg)">
        <div class="overlay"></div>
        <div class="gtco-container">
            <div class="row">
                <div class="col-md-12 col-md-offset-0 text-left">
                ...
                <div class="item">
                    <img src="../images/01.png"   style="     width: 1400px; height: 300px;" alt="..." class="grayscale">
                ...
                <div class="item">
                    <img src="../images/02.jpg"    style="     width: 1400px; height: 300px;"alt="..." class="grayscale">
            ...
            <div class="gtco-container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                        <h2>our services</h2>
                        <p>We havee much more than these  services listed below .</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <a href="../images/02.jpg" class="fh5co-project-item image-popup">
                            ...
                            <div class="fh5co-text">
                                <h2>Title service number 1</h2>
                                <p>Describtion and details </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <a href="../images/01.png" class="fh5co-project-item image-popup">
                            <figure>
                                <div class="overlay"><i class="ti-plus"></i></div>
                                <img src="../images/01.png" Image" class="img-responsive">
                            </figure>
                            <div class="fh5co-text">
                                <h2>Title service number 1</h2>
                                <p>Describtion and details </p>
            ...
            <div class="gtco-container">
                ...
                <div class="row">
                    <div class="owl-carousel owl-carousel-carousel">
                        <div class="item">
                            <a href="#"><img src="../images/01.png" alt="Free HTML5 Bootstrap Template by FreeHTML5.co"></a>
                        </div>
                        <div class="item ">
                            <a href="#"><img src="../images/03.png" alt="Free HTML5 Bootstrap Template by FreeHTML5.co"></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="../images/02.jpg" alt="Free HTML5 Bootstrap Template by FreeHTML5.co"></a>
                        </div>
                        <div class="item">
                            <a href="#"><img src="../images/00.png" alt="Free HTML5 Bootstrap Template by FreeHTML5.co"></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    border-radius: 5px;" id="äccount_type_ul" >
                                            ...
                                            <div class="tab-content-inner" data-content="login">
                                                <form action="#">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <label for="d">Username or Email</label>
